...
{
    public static class ProductSetV20231129
    {
        public static ProductSet ProductSet = new ProductSet()
        {
            ...
            ProductCategoriesFr = new ProductCategory[]
            {
                ...
                new ProductCategory()
                {
                    ...
                    image = "oc/pest/rodent",
                    subcategories = new string[] {"RATS", "RATS: GLUAUX", "RATS: PIÈGES", "RONGEURS", "RONGEURS: APPÂT", "RONGEURS: EXCLUSION", "RONGEURS: GLUAUX", "RONGEURS: PIÈGES", "RONGEURS: RODENTICIDE", "RONGEURS: STATION D'APPÂT", "SOURIS", "SOURIS: GLUAUX", "SOURIS: PIÈGES"}
                },
                new ProductCategory()
                {
                    id = "SOAK TANK",
            ...
            ProductsFr = new Product[]
            {
                ...
                {
                    Category = "INSECTES: SPP: MONITEURS",
                    Name = "ULTRA-COMBI QUIK REBAIT DOME PAQUET DE 6",
                    Vendor = "TRECE, INC",
                    ProductId = "793743",
                    PCPNum = "",
                    UOM = "KT",
